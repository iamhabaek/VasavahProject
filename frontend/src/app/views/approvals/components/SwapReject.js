...
import { rejectSwap } from "app/reducers/actions/ClassroomActions";
const basicFormSchema = yup.object().shape({
  reason: yup.string().required("Reason is required"),
});
const SwapReject = ({ reason, handleReject, id, token, dispatch }) => {
  console.log(id);
  ...
  const handleSubmit = async (values) => {
    ...
    setLoading(true);
    await rejectSwap(id, reject, token)(dispatch);
    setLoading(false);
  };
  return (
    <Fragment>
